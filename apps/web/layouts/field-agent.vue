    ...
    <div class="flex-1 flex flex-col min-w-0">
      ...
      <header class="hidden lg:flex items-center justify-between px-8 py-4 border-b border-border bg-background">
        ...
        <div class="flex items-center gap-3">
          ...
          <button @click="authStore.logout()" class="flex items-center justify-center w-10 h-10 rounded-lg border border-border hover:bg-surface transition-colors" title="Logout" aria-label="Sign out">
