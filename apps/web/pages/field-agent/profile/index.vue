...
<template>
  <div class="flex flex-col gap-5 max-w-[480px] mx-auto">
    ...
    <div class="bg-card border border-border rounded-xl p-6 flex flex-col items-center gap-3">
      ...
      <span class="bg-st-amber-bg text-st-amber-text rounded-full px-3 py-1 text-[11px] font-mono font-semibold uppercase tracking-wider">Field Agent</span>
    ...
    <div class="grid grid-cols-3 gap-3">
      <div class="bg-card border border-border rounded-xl p-3.5 flex flex-col items-center gap-1">
        ...
        <span class="font-mono text-xl font-bold text-st-green-text">{{ stats?.completed ?? '—' }}</span>
      </div>
      <div class="bg-card border border-border rounded-xl p-3.5 flex flex-col items-center gap-1">
