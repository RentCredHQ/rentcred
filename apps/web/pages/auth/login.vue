...
<template>
  <div>
    ...
    <button
      disabled
      class="w-full py-3 border border-border text-muted-foreground font-sans text-sm font-medium flex items-center justify-center gap-3 opacity-50 cursor-not-allowed"
      title="Coming soon"
    >
