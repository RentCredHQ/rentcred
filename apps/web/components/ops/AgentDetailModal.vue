...
watch(() => show.value, async (open) => {
  ...
  try {
    ...
    recentCases.value = (a.recentCases ?? a.assignments ?? []).slice(0, 5).map((c: any) => {
      const style = statusStyleMap[c.status] ?? { bg: 'bg-st-amber-bg', text: 'text-st-amber-text' }
      return {
          ...
          <div v-if="agent" class="flex flex-col gap-5 p-6">
            ...
            <div class="grid grid-cols-3 gap-3">
              ...
              <div class="bg-background rounded-lg p-3 flex flex-col gap-1">
                ...
                <span class="font-mono text-lg font-bold text-st-green-text">{{ agent.completedCases ?? 0 }}</span>
            ...
            <div class="flex flex-col gap-3">
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <span class="inline-flex items-center gap-1 font-sans text-[13px] text-st-green-text">
